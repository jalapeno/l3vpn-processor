...
import (
	...
	"www.github.com/jalapeno/l3vpn-processor/pkg/arangodb"
	"www.github.com/jalapeno/l3vpn-processor/pkg/kafkamessenger"
...
var (
	...
	l3vpnPrefixV4Edge string
	l3vpnPrefixV6Edge string
	vrf               string
...
func init() {
	...
	flag.StringVar(&l3vpnNode, "l3vpn_node", "l3vpn_node", "l3vpn_node Collection name, default: \"l3vpn_node\"")
	...
	flag.StringVar(&l3vpnPrefixV4Edge, "l3vpn_v4_prefix_edge", "l3vpn_v4_prefix_edge", "l3vpn_v4_prefix_edge Collection name, default: \"l3vpn_v4_prefix_edge\"")
	flag.StringVar(&l3vpnPrefixV6Edge, "l3vpn_v6_prefix_edge", "l3vpn_v6_prefix_edge", "l3vpn_v6_prefix_edge Collection name, default: \"l3vpn_v6_prefix_edge\"")
	flag.StringVar(&vrf, "vrf", "vrf", "vrf Collection name, default: \"vrf\"")
}
...
func main() {
	...
	dbSrv, err := arangodb.NewDBSrvClient(dbSrvAddr, dbUser, dbPass, dbName, peer, bgpNode,
		unicastprefixV4, unicastprefixV6, ebgpprefixV4, ebgpprefixV6, inetprefixV4, inetprefixV6,
		l3vpnNode, l3vpnPrefixV4, l3vpnPrefixV6, l3vpnPrefixV4Edge, l3vpnPrefixV6Edge, vrf)
	if err != nil {
